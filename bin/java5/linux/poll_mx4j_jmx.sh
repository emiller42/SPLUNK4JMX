...
"$JAVA" -Xbootclasspath/a:$BOOTPATH -Djava.library.path=$ATTACH_LIBRARY_PATH -Dsplunk4jmx.home=$SPLUNK4JMX_HOME $JAVA_OPTS -classpath $LIB_DIR:$POLLER_JARS $MAIN_CLASS $CONFIG_XML
