...
set ATTACH_LIBRARY_PATH=%JAVA_HOM%/jre/lib/i386
...
set POLLER_JARS=%LIB_DIR%/jmxpoller.jar;%LIB_DIR%/axis.jar;%LIB_DIR%/saaj.jar;%LIB_DIR%/slf4j-api-1.6.4.jar;%LIB_DIR%/castor-1.3-core.jar;%LIB_DIR%/slf4j-log4j12-1.6.4.jar;%LIB_DIR%/castor-1.3-xml.jar;%LIB_DIR%/splunk.jar;%LIB_DIR%/commons-discovery-0.2.jar;%LIB_DIR%/splunklogging.jar;%LIB_DIR%/commons-logging-1.1.1.jar;%LIB_DIR%/hessian-3.0.8.jar;%LIB_DIR%/tools-win.jar;%LIB_DIR%/jaxrpc.jar;%LIB_DIR%/wsdl4j.jar;%LIB_DIR%/log4j-1.2.16.jar;%LIB_DIR%/xercesImpl.jar;%LIB_DIR%/mx4j-tools.jar
...
"%JAVA%" "-Xbootclasspath/a:%BOOTPATH%"  "-Dsplunk4jmx.home=%SPLUNK4JMX_HOME% -Djava.library.path=%ATTACH_LIBRARY_PATH%"  %JAVA_OPTS% -classpath "%LIB_DIR%;%POLLER_JARS%"  %MAIN_CLASS% "%CONFIG_XML%"
